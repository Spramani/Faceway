                        ...
                        <div class="row">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <input type="hidden" name="hiddenid" value="{{ $id }}">
                                    ...
                                    <input class="form-control" name="otpcode" type="text" placeholder="">
                                    <span class="material-input"></span></div>
                                    <button class="btn btn-primary" onclick="checkotp()">Varify OTP Code</button>
                                <div id="newpss" class="d-none">
                                    <div class="form-group label-floating is-empty">
                                    ...
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <input class="form-control" name="newcpass" type="password" placeholder="">
                                        <span class="material-input"></span></div>
                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with
                                        anyone
                                        else.</small>
                                    <br />
                                    <button class="btn btn-primary" onclick="setpass()">Set Password</button>
                                </div>
